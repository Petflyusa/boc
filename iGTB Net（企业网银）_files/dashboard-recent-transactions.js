(function (root, factory) {
  ...
  function render() {
    ...
    var card = document.querySelector('[cardtitle="余额视图"]');
    var target = card && card.querySelector('.recent-trade .trade-card');
    ...
    if (!document.getElementById('bocRecentTransactionsStyles')) {
      ...
      style.textContent = '.boc-recent-transactions{height:100%;box-sizing:border-box;padding:8px 12px;background:#fff}.boc-recent-heading{display:flex;align-items:center;justify-content:space-between;margin:0 0 6px;color:#333;font-size:12px}.boc-recent-heading span{font-size:11px;color:#999;font-weight:400}.boc-recent-table-wrap{width:100%;height:calc(100% - 25px);overflow:auto;border:1px solid #eee;border-radius:3px}.boc-recent-table-wrap table{width:100%;min-width:540px;border-collapse:collapse;font-size:11px}.boc-recent-table-wrap th{height:28px;padding:0 7px;background:#fafafa;color:#777;text-align:left;font-weight:500;white-space:nowrap}.boc-recent-table-wrap td{height:31px;padding:3px 7px;border-top:1px solid #f0f0f0;white-space:nowrap}.boc-recent-table-wrap th:nth-child(n+3),.boc-recent-table-wrap td:nth-child(n+3){text-align:right}.boc-recent-type{display:block;color:#444;font-weight:500}.boc-recent-counterparty{display:block;margin-top:2px;color:#999;font-size:10px}.boc-recent-income{color:#c1282c;font-weight:600}.boc-recent-expense{color:#388e3c;font-weight:600}.boc-recent-balance{color:#555}.boc-recent-empty{text-align:center!important;color:#999;height:50px!important}@media(max-width:760px){.boc-recent-transactions{padding:8px}.boc-recent-table-wrap table{min-width:540px}}';
